...
```
ChaBaiDao-AI-Innovation-Toolkit/
├── README.md                      # 项目说明（本文件）
├── docs/                          # 文档材料目录
...
| 模块 | 名称 | 核心功能 | 飞书AI工具 |
|------|------|----------|-----------|
| 模块一 | 精准识人 | NLP情绪聚类，按"口感性格"分群 | 多维表格AI字段提取 |
| 模块二 | 打造爆款 | 生成式AI辅助小料配方共创 | My AI辅助研发简报 |
| 模块三 | 智能造场 | AI Agent自动生成门店差异化策略 | AI Agent自动生成话术 |
| 模块四 | 商业闭环 | 爆款存活率预测模型，减少供应链浪费 | 多维表格数据建模 |
